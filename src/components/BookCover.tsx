...
export function BookCover({ 
  ...
  return (
    <div 
      ...
      className="relative w-[560px] h-[794px] max-w-full print:w-full print:h-full print:aspect-[148/210] mx-auto rounded-none overflow-hidden flex flex-col shadow-[0_10px_25px_-5px_rgba(0,0,0,0.15),0_8px_10px_-6px_rgba(0,0,0,0.15)]"
      style={{ 
