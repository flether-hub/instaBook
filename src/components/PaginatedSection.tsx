...
export function PaginatedSection({ content, outlineTitle, sectionHeader, sectionFooter, startPageCounter, onPagesCalculated, isLoading, pageIdPrefix }: PaginatedSectionProps) {
  ...
  return (
    <>
      {Array.from({ length: totalPages }).map((_, i) => (
        <div 
          key={i} 
          id={pageIdPrefix ? `page-anchor-${pageIdPrefix}-${i}` : undefined} 
          className="book-page-preview page-break flex flex-col relative content-page overflow-hidden bg-[#fcfbf8]"
        >
